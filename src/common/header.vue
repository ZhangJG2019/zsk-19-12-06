      ...
      <div class="w-box">
        <div class="nav-logo">
          <h1 @click="changePage(-1)">
            <router-link to="/home" title="三济生物官网">三济生物</router-link>
          </h1>
        </div>
        <div class="right-box">
          <div class="nav-list">
          ...
          <div class="nav-aside" ref="aside" :class="{ fixed: false }">
            <!-- <div class="user pr">
              <a href="http://47.105.75.254:9100/cas?service=http://47.105.75.254:8080/jump">个人中心</a>
              <div class="nav-user-wrapper pa" v-if="this.loginShow">
...
export default {
  ...
  methods: {
    ...
    _loginOut() {
      ...
      function test1() {
        // window.location.href = 'http://192.168.1.154/#/home'
...
<style lang="scss">
.right-box > .nav-list > span.el-input__suffix {
  right: 0px !important;
...
.header-box {
  ...
  background-image: -webkit-linear-gradient(#fefefe, #ffffff);
  // background-image: linear-gradient(#000, #121212);
  background-image: linear-gradient(#fefefe, #ffffff);
  width: 100%;
}
...
.w-box {
  ...
  h1 {
    ...
    > a {
      ...
      background: url(/static/images/newimg/Logo2.png) no-repeat;
