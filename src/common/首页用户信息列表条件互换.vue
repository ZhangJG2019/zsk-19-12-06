          ...
          <div class="nav-sub-wrapper" :class="{ fixed: st }">
            <div class="w">
              <ul class="nav-list2">
                <li style="nav-img">
                  <img
                    src="../../static/images/newimg/Logo2.png"
                    alt
                    style="vertical-align: middle;width: 170px;"
                  />
                </li>
                <li>
                ...
                <li @click.stop="zskyonghu">
                  <a>知识库用户</a>
                </li>
                <li @click.stop="xiazai">
                  <a>下载</a>
                </li>
                <li @click.stop="bangzhu">
                  <a>帮助</a>
                </li>
                <li>
                  <a to="/">关于</a>
              ...
              <div class="user pr">
                ...
                <!--用户信息显示-->
                <p v-if="this.userName!==null" ref="aside">
                  <span style="color:#000;" class="iconfont icon-weibiaoti12"></span>
                  <span style="color:#000;margin:0 5px;" @click="top_menu">菜单</span>
                  <span style="color:#000;" class="iconfont icon-xiajiantou"></span>
                </p>
...
.nav-sub {
  ...
  &.fixed {
    ...
    background-image: url("../../static/images/newimg/Logo2.png");
