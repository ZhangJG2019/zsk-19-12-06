    ...
    <div class="w clearfix d-flex">
      ...
      <div class="right-content-box detail-box-content">
        <div v-if="tabsCur=='0'">
          ...
          <div class="text-box" v-html="zongji.summary"></div>
          <h4 class="section-box">相关通路</h4>
          <div class="text-box" v-html="zongji.relatedPathways"></div>
          <h4 class="section-box">参考文献</h4>
          <div class="text-box" v-html="zongji.publication"></div>
          ...
          <div class="text-box" v-html="zongji.description"></div>
          <h4 class="section-box">作者</h4>
          <div class="text-box" v-html="zongji.authors"></div>
          <h4 class="section-box">引文</h4>
          <div class="text-box" v-html="zongji.citation"></div>
          <h4 class="section-box">治疗类别</h4>
          <div class="text-box" v-html="zongji.therapaeutic"></div>
          ...
          <div class="text-box" v-html="zongji.history"></div>
        </div>
        ...
        <div v-if="tabsCur=='1'">
          ...
          <div class="text-box" v-html="zuchengbufen.interactions"></div>
          <h4 class="section-box">通路中的关系</h4>
          <div class="text-box" v-html="zuchengbufen.relationships"></div>
        </div>

        <div v-if="tabsCur=='2'">
          <h4 class="section-box">相关通路</h4>
          <div class="flex-center flex-between" style="padding:10px 0;">
          ...
          <div class="table">
            <el-table border style="width: 100%" :data="relatedParhways">
              <el-table-column prop="relatedPathways" label="通路" align="center"></el-table-column>
              <el-table-column prop="cf1" label="药物" align="center"></el-table-column>
              <el-table-column prop="cf2" align="center" label="基因"></el-table-column>
              <el-table-column prop="cf3" width="80" align="center" label="表型"></el-table-column>
            </el-table>
          </div>
        </div>
        ...
        <div v-if="tabsCur=='3'">
          ...
          <div class="table">
            <el-table border style="width: 100%" :data="pathways_Data">
              <el-table-column prop="chemicals" width="100" align="center" label="药物"></el-table-column>
              <el-table-column prop="gene" width="90" align="center" label="基因"></el-table-column>
              <el-table-column prop="pmid" align="center" width="100" label="PMID"></el-table-column>
              ...
              <el-table-column prop="journal" align="center" width="160" label="期刊"></el-table-column>
              <el-table-column prop="year" align="center" width="60" label="年份"></el-table-column>
            </el-table>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    filterD(arr, str) {
      return arr.filter(
        res => res.pathways && res.pathways.indexOf(str) >= "0"
      );
    },
    queryData() {
