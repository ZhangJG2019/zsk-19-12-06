    ...
    <div style="border-top:1px solid #eee;">
      <div class="w clearfix d-flex">
        ...
        <div class="right-content-box">
              ...
              <ul>
                ...
                >
                  ...
                  <div class="table">
                    ...
                    >
                      <tr>
                        <td class="td_left hui" style="height:40px;width:90px;text-align:center;">案例</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">类型</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">药物</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">疾病</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">基因</td>
                      </tr>
                      <tr>
                        <td
                          class="td_left"
                          ...
                          v-text="item.ofCase"
                        ></td>
                        <td class="td_left" style="text-align:center;" v-text="item.type"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.chemicals"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.disease"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.gene"></td>
                      </tr>
                      <tr>
                        <td class="td_left hui" style="height:40px;text-align:center;">等位基因:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">假定值:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">研究方法:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">种族:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">人口学特征:</td>
                      </tr>
                      <tr>
                        <td class="td_left" style="text-align:center;" v-text="item.otherGenes"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.pValue"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.typeOfStudy"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.race"></td>
                        <td
                          class="td_left"
          ...
          <div class="china-box" v-if="this.queryObj.type=='2'">
            <div class="detail-box-top">
              ...
              <ul>
                ...
                >
                  ...
                  <div class="table">
                    ...
                    >
                      <tr>
                        <td class="td_left hui" style="height:40px;text-align:center;">案例:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">类型:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">药物:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">表型:</td>
                        <td class="td_left hui" style="height:40px;text-align:center;">基因:</td>
                      </tr>
                      <tr>
                        <td class="td_left" style="text-align:center;" v-text="item.ofCase"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.type"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.chemicals"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.phenotypes"></td>
                        <td class="td_left" style="text-align:center;" v-text="item.gene"></td>
                      </tr>
                      <tr>
                        <td class="td_left hui" style="height:40px;text-align:center;">等位基因:</td>
