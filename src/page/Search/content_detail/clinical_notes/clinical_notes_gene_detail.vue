        ...
        <div class="left-box" v-if="this.tabs.length>1">
          ...
          <ul class="tips-list">
            ...
            >
              ...
              <p class="ellipsis" style="font-size:15px;">{{item.projectName}}</p>
            </li>
          </ul>
        </div>
              ...
              <ul class="section-box-word">
                ...
                >
                  ...
                  <dl class="clearfix qkuang-list">
                    <dd v-for="(list,index) of item.resultList" :key="'result'+index">{{list}}</dd>
                  </dl>
                </li>
              </ul>
              ...
              <div class="table">
                <el-tabs v-model="activeName2" type="card">
                  <el-tab-pane label="国内文献" name="first">
                    <el-table border style="width: 100%" :data="dataObj.literatureCoreInfoList">
                      <el-table-column type="index" width="50" label="序号" align="center"></el-table-column>
                      <el-table-column label="题目" align="left">
                      ...
                      <el-table-column prop="source" width="180" align="center" label="期刊"></el-table-column>
                  ...
                  <el-tab-pane label="国外文献" name="second">
                    <el-table border style="width: 100%" :data="dataObj.literatureSciInfoList">
                      ...
                      <el-table-column prop="journal" width="180" align="center" label="期刊"></el-table-column>
                      <el-table-column prop="year" width="80" align="center" label="年份"></el-table-column>
                    </el-table>
                  </el-tab-pane>
                </el-tabs>
