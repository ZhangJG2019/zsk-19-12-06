<template>
  <div class="drug-news">
    ...
    <div class="w clearfix d-flex">
      ...
      <div class="right-content-box detail-box-content">
        ...
        <div v-if="tabsCur=='1'">
          ...
          <div class="drug-news-box">
            <ul class="section-box-word">
              <li class="word-list" v-for="(item, index) in shopName" :key="'shop'+index">
                <i class="word-icon"></i>
                <div class="boxes">
        ...
        <div v-if="tabsCur=='2'">
          ...
          <div class="drug-news-box">
            <ul class="section-box-word">
              <li class="word-list" v-for="(item, index) in shuoMingShu" :key="'sms'+index">
                <i class="word-icon"></i>
                <div class="boxes">
                  ...
                  <p style=" margin-top:15px;">
                    <span class="undline-text" @click="topageURL(item.accessoryUrl)">查看全文</span>
                    <em class="line-black">|</em>
                    <a :href="burl+item.accessoryUrl" download="pdf" class="undline-text">下载</a>
                    <em class="line-black">|</em>
                    <span @click="imgShow(item.accessoryImageId)" class="undline-text">包装图片</span>
                  </p>
                </div>
              </li>
            </ul>
        ...
        <div v-if="tabsCur=='3'">
          <h4 class="section-box">医保目录</h4>
          <div class="drug-news-box">
            <ul class="section-box-word">
              <li class="word-list" v-for="(item, index) in yiBao" :key="'yb'+index">
                <i class="word-icon"></i>
                <div class="boxes">
        ...
        <div v-if="tabsCur=='4'">
          <h4 class="section-box">药物相互作用</h4>
          <div class="drug-news-box">
            <ul class="section-box-word">
              <li class="word-list" v-for="(item, index) in xiangHu" :key="'xhzy'+index">
                <i class="word-icon"></i>
                <div class="boxes">
    ...
    <el-dialog :visible.sync="dialogVisible" width="640px">
      <el-carousel :autoplay="false" trigger="click" height="600px" width="600px">
        <el-carousel-item v-for="item in imgArr" :key="item">
          <a :href="burl+item.accessoryImageUrl" download="img">
            <img :src="burl+item.accessoryImageUrl" width="600px" height="600px" />
          </a>
        </el-carousel-item>
      </el-carousel>
    </el-dialog>
