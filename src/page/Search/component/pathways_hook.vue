      ...
      <el-tab-pane label="参与通路" name="first">
        ...
        <div class="table">
          <el-table border :data="dataList" style="width: 100%">
            <el-table-column label="通路" align="center" width="160">
            ...
            <el-table-column prop="drugs" label="药物" align="center"></el-table-column>
            <el-table-column prop="genes" align="center" label="基因"></el-table-column>
            <el-table-column prop="diseases" width="60" align="center" label="疾病"></el-table-column>
          </el-table>
        </div>
      </el-tab-pane>
    </el-tabs>
