<template>
  <div class="hook-box">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="中国药物标签" name="first">
        ...
        <div class="table">
          <el-table border style="width: 100%" :data="china_CFDA_hook">
            <el-table-column prop="drugName" width="150" label="药物" align="center">
              <template slot-scope="scope">
                <p>{{scope.row.drugName}}</p>
                <p>（{{scope.row.englishName}}）</p>
              </template>
            </el-table-column>
            <el-table-column prop="geneName" width="100" label="基因" align="center"></el-table-column>
            ...
            <el-table-column prop="source" width="80" label="来源" align="center">
              <!-- <template slot-scope="scope">
                <p
      ...
      <el-tab-pane label="全球药物标签" name="second">
        <h6 style="margin-top:10px; font-size:20px; color:#333;">概述</h6>
        <div class="text-box">
        ...
        <div class="table">
          <el-table border style="width: 100%" :data="foreign_drug_hook">
            <el-table-column prop="drugName" width="150" label="药物" align="center">
              <template slot-scope="scope">
                <p>{{scope.row.drugName}}</p>
                <p>（{{scope.row.englishName}}）</p>
            ...
            <el-table-column prop="geneName" width="100" label="基因" align="center"></el-table-column>
            <el-table-column prop="pgxLevel" width="150" label="循证等级" align="center">
              <!-- <template slot-scope="scope">
                <p
                  class="ellipsis td-li-text"
                  v-for="(list,index) of scope.row.drugLabelList"
