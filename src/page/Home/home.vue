<template>
  <div class="login">
    <YHeaders></YHeaders>
    <div class="searchBox" style="padding-top:3.3125rem;height:12rem;background-color:#1f7fb7; ">
      <!-- 中间搜索框 -->
    ...
    <div class="activity-panel">
      ...
      <ul class="box">
        ...
        <li class="center_content" @click="gene">
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/home-gene.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px;" -->
          <a href class="ENGtitle">Genes</a>
        ...
        <li class="center_content" @click="drug">
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/home-drug.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px" -->
          <a href class="ENGtitle">Drugs</a>
        ...
        <li class="center_content" @click="drugGenePair">
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/drug-gene.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px" -->
          <a href class="ENGtitle">Drugs-Genes</a>
          <a href class="title">药物-基因</a>
          <!-- <a class="num">789</a> -->
          <a class="num" v-text="drugGenePairnum"></a>
        </li>
        <li style="width:20px;height:100px;"></li>
        <!-- style="background-color:rgba(1, 196, 195,0.5);" -->
        <li class="center_content" @click="authority">
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/linchuangzhinan.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px" -->
          <a href class="ENGtitle">Clinical Guidelines</a>
      ...
      <ul class="box">
        ...
        <li class="center_content" @click="drugLabels">
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/drug-title.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px" -->
          <a href class="ENGtitle">Drug Labels</a>
        ...
        <li class="center_content" @click="clinicalNotes">
          <!-- <li class="center_content"> -->
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/linchuangzhushi.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px" -->
          <a href class="ENGtitle">Clinical Annotations</a>
        ...
        <li class="center_content" @click="clinicalTrials">
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/linchuangshiyan.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px" -->
          <a href class="ENGtitle">Clinical Trial</a>
        ...
        <li class="center_content" @click="patent">
          <div
            style="width:60px;height:60px;float:left;margin: 20px; border-radius: 50%;  background-image: url(/static/images/newimg/home-partents.png);background-repeat:no-repeat;background-size:60%;background-position:center center;background-color:#e7eff2;"
          ></div>
          <!-- style="width:50px;height:50px" -->
          <a href class="ENGtitle">Patents</a>
      ...
      <div class="guide_ul">
        <div class="cent_left" style="width:60%;float:left;">
          ...
          <div class="left_cent">
            <ul>
              <li style="width:100%;" v-for="(item, key) in newTask" :key="key">
                <div class="right_left" style="float:left; padding:2rem 1rem 0 0 ;">
                  <!-- <span
                ...
                >
                  ...
                  <el-button type="primary" @click="More()" style="padding:10px 20px">参与任务</el-button>
                </div>
              </li>
        ...
        <div class="cent_right" style="width:30%;float:right;">
          ...
          <div class="right_cent">
            <ul>
              <li v-for="(item, key) in topNewss" :key="key">
    ...
    <div class="clearfix" style="background-color:#f8f9fd;"></div>
    <YFooter></YFooter>
  </div>
</template>
<script>
