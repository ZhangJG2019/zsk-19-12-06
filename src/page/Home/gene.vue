    ...
    <label-page style=" min-height: calc(100vh - 230px);">
      ...
      <div class="content-box">
        ...
        <ul v-loading="loading" style="min-height:150px;">
          <li class="content-list" v-for="(item,index) of tableData" :key="'gene+'+index">
            ...
            <div class="table">
              <el-table :data="item.genePorInfo" border style="width: 100%">
                <el-table-column prop="genePor" label="位点" align="center" width="240"></el-table-column>
                <el-table-column prop="rsId" label="位点RSID" align="center" width="180"></el-table-column>
                <el-table-column align="center" label="频率">
                  <template slot-scope="scope">
                    <p>{{scope.row.frequency&&scope.row.frequency.join("|")||"--"}}</p>
                  </template>
                </el-table-column>
                <el-table-column width="180" align="center" label="来源">
                  <template slot-scope="scope">
